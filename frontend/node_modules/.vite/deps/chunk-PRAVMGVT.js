...
import {
  Stack_default
} from "./chunk-YHREA5WY.js";
import {
  Box_default
} from "./chunk-JHV2M32J.js";
import {
  Button_default
...
function SignInPage(props) {
  ...
  const hasOauthProvider = React21.useMemo(() => providers == null ? void 0 : providers.some((provider) => isOauthProvider(provider.id)), [isOauthProvider, providers]);
              ...
              children: [isPasskeyProvider(provider.id) ? (0, import_jsx_runtime23.jsxs)(React21.Fragment, {
                children: [hasOauthProvider || index > 0 ? (0, import_jsx_runtime23.jsx)(Divider_default, {
                  ...
                  onSubmit: async (event) => {
                    ...
                    const passkeyResponse = await (signIn == null ? void 0 : signIn(provider, formData, callbackUrl));
                    setFormStatus((prev) => ({
                      ...prev,
                      loading: false,
                ...
                children: [hasOauthProvider || index > 0 ? (0, import_jsx_runtime23.jsx)(Divider_default, {
                  ...
                  onSubmit: async (event) => {
                    ...
                    const formData = new FormData(event.currentTarget);
                    const emailResponse = await (signIn == null ? void 0 : signIn(provider, formData, callbackUrl));
                    setFormStatus((prev) => ({
                      ...prev,
                      loading: false,
                ...
                children: [hasOauthProvider || index > 0 ? (0, import_jsx_runtime23.jsx)(Divider_default, {
                  ...
                  onSubmit: async (event) => {
                    ...
                    event.preventDefault();
                    const formData = new FormData(event.currentTarget);
                    const credentialsResponse = await (signIn == null ? void 0 : signIn(provider, formData, callbackUrl));
                    setFormStatus((prev) => ({
                      ...prev,
                      loading: false,
                  ...
                  children: [(0, import_jsx_runtime23.jsxs)(Stack_default, {
                  ...
                  }), (slots == null ? void 0 : slots.forgotPasswordLink) || (slots == null ? void 0 : slots.rememberMe) ? (0, import_jsx_runtime23.jsxs)(Stack_default, {
                    direction: "row",
                    ...
                    }) : null, (slots == null ? void 0 : slots.forgotPasswordLink) ? (0, import_jsx_runtime23.jsx)(slots.forgotPasswordLink, {
                      ...slotProps == null ? void 0 : slotProps.forgotPasswordLink
                    }) : null]
                  }) : null, (slots == null ? void 0 : slots.submitButton) ? (0, import_jsx_runtime23.jsx)(slots.submitButton, {
                    ...slotProps == null ? void 0 : slotProps.submitButton
                  }) : (0, import_jsx_runtime23.jsx)(Button_default, {
                    type: "submit",
                    fullWidth: true,
...
//# sourceMappingURL=chunk-PRAVMGVT.js.map
